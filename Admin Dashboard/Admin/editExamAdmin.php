...
<?php
        ...
        if (isset($_REQUEST["add"])) {
            if (($_REQUEST['name'] == "") || ($_REQUEST['address'] == "")) {
                ...
                $sql = "UPDATE examadmin SET name='$name',email='$email' WHERE 1";
    ...
    if (isset($_REQUEST['view'])) {
        $sql = "SELECT * FROM examadmin WHERE id={$_REQUEST['id']}";
    ...
    ?>
            <form class="Add" action="" method="POST">
                ...
                <input placeholder="Name" type="text" id="name" name="name" value="<?php if (isset($row['name'])) {
                                                                                                echo $row['name'];
                                                                                            } ?>"><br>
